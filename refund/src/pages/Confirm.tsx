...
export function Confirm() {
    ...
    return (
        <div className="bg-gray-500 lg:w[512px]  rounded-xl flex flex-col items-center p-10 gap-6">
            ...
            <p className=" text-sm text-gray-200 text-center">Agora é só aguardar! Sua solicitação será analizada em breve, o setor finaceiro irá entrar em contato com você.</p>
